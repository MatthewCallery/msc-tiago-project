...
if("TRUE" STREQUAL "TRUE")
  set(play_motion_SOURCE_PREFIX /home/mc16766/tiago_public_ws/src/play_motion/play_motion)
  set(play_motion_DEVEL_PREFIX /home/mc16766/tiago_public_ws/devel/.private/play_motion)
  ...
  set(play_motion_INSTALL_PREFIX /home/mc16766/tiago_public_ws/install)
...
if(NOT "/home/mc16766/tiago_public_ws/src/play_motion/play_motion/include " STREQUAL " ")
  set(play_motion_INCLUDE_DIRS "")
  set(_include_dirs "/home/mc16766/tiago_public_ws/src/play_motion/play_motion/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'play_motion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mc16766/tiago_public_ws/src/play_motion/play_motion/${idir}'.  Ask the maintainer 'Victor Lopez <victor.lopez@pal-robotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mc16766/tiago_public_ws/devel/.private/play_motion/lib;/home/mc16766/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
