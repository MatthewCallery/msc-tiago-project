...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_msgs_SOURCE_PREFIX /home/mc16766/tiago_public_ws/src/ros_control/controller_manager_msgs)
  set(controller_manager_msgs_DEVEL_PREFIX /home/mc16766/tiago_public_ws/devel/.private/controller_manager_msgs)
  ...
  set(controller_manager_msgs_INSTALL_PREFIX /home/mc16766/tiago_public_ws/install)
...
if(NOT "/home/mc16766/tiago_public_ws/devel/.private/controller_manager_msgs/include " STREQUAL " ")
  set(controller_manager_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/mc16766/tiago_public_ws/devel/.private/controller_manager_msgs/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mc16766/tiago_public_ws/src/ros_control/controller_manager_msgs/${idir}'.  Ask the maintainer 'Wim Meeussen <wim@hidof.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mc16766/tiago_public_ws/devel/.private/controller_manager_msgs/lib;/home/mc16766/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
