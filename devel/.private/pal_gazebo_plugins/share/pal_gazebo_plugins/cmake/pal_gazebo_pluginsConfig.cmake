...
if("TRUE" STREQUAL "TRUE")
  set(pal_gazebo_plugins_SOURCE_PREFIX /home/mc16766/tiago_public_ws/src/pal_gazebo_plugins)
  set(pal_gazebo_plugins_DEVEL_PREFIX /home/mc16766/tiago_public_ws/devel/.private/pal_gazebo_plugins)
  ...
  set(pal_gazebo_plugins_INSTALL_PREFIX /home/mc16766/tiago_public_ws/install)
...
if(NOT "/home/mc16766/tiago_public_ws/src/pal_gazebo_plugins/include;/usr/include;/usr/include/gazebo-2.2;/usr/include/sdformat-1.4 " STREQUAL " ")
  set(pal_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/mc16766/tiago_public_ws/src/pal_gazebo_plugins/include;/usr/include;/usr/include/gazebo-2.2;/usr/include/sdformat-1.4")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pal_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mc16766/tiago_public_ws/src/pal_gazebo_plugins/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>, Luca Marchionni <luca.marchionni@pal-robotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mc16766/tiago_public_ws/devel/.private/pal_gazebo_plugins/lib;/home/mc16766/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
