...
if("TRUE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX /home/mc16766/tiago_public_ws/src/ros_controllers/velocity_controllers)
  set(velocity_controllers_DEVEL_PREFIX /home/mc16766/tiago_public_ws/devel/.private/velocity_controllers)
  ...
  set(velocity_controllers_INSTALL_PREFIX /home/mc16766/tiago_public_ws/install)
...
if(NOT "/home/mc16766/tiago_public_ws/src/ros_controllers/velocity_controllers/include " STREQUAL " ")
  set(velocity_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/home/mc16766/tiago_public_ws/src/ros_controllers/velocity_controllers/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mc16766/tiago_public_ws/src/ros_controllers/velocity_controllers/${idir}'.  Ask the maintainer 'Vijay Pradeep <vijay@hidof.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mc16766/tiago_public_ws/devel/.private/velocity_controllers/lib;/home/mc16766/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
