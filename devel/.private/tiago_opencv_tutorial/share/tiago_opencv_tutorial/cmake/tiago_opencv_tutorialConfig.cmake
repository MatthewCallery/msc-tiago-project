...
if("TRUE" STREQUAL "TRUE")
  set(tiago_opencv_tutorial_SOURCE_PREFIX /home/mc16766/tiago_public_ws/src/tiago_tutorials/tiago_opencv_tutorial)
  set(tiago_opencv_tutorial_DEVEL_PREFIX /home/mc16766/tiago_public_ws/devel/.private/tiago_opencv_tutorial)
  ...
  set(tiago_opencv_tutorial_INSTALL_PREFIX /home/mc16766/tiago_public_ws/install)
...
if(NOT "/home/mc16766/tiago_public_ws/devel/.private/tiago_opencv_tutorial/include " STREQUAL " ")
  set(tiago_opencv_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/home/mc16766/tiago_public_ws/devel/.private/tiago_opencv_tutorial/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tiago_opencv_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mc16766/tiago_public_ws/src/tiago_tutorials/tiago_opencv_tutorial/${idir}'.  Ask the maintainer 'Jordi Pages <jordi.pages@pal-robotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mc16766/tiago_public_ws/devel/.private/tiago_opencv_tutorial/lib;/home/mc16766/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
