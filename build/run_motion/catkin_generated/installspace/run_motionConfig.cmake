...
if("FALSE" STREQUAL "TRUE")
  set(run_motion_SOURCE_PREFIX /home/mc16766/tiago_public_ws/src/tiago_tutorials/run_motion)
  set(run_motion_DEVEL_PREFIX /home/mc16766/tiago_public_ws/devel/.private/run_motion)
  ...
  set(run_motion_INSTALL_PREFIX /home/mc16766/tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'run_motion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mc16766/tiago_public_ws/install/${idir}'.  Ask the maintainer 'Jordi Pages <jordi.pages@pal-robotics.com>, Sammy Pfeiffer <sam.pfeiffer@pal-robotics.com>' to fix it.")
    endif()
